...
{
    if (_node.overrides & ASMethodOverrideTouchesBegan) {
...
{
    if (_node.overrides & ASMethodOverrideTouchesMoved) {
...
{
    if (_node.overrides & ASMethodOverrideTouchesEnded) {
...
{
    if (_node.overrides & ASMethodOverrideTouchesCancelled) {
